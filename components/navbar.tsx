...
function NewsletterForm() {
  return (
    <div className="flex items-start gap-[12px]">
      <input
        placeholder="ikant@metaphysical.org"
        type="text"
        className="flex w-[260px] py-[10px] px-[14px] items-center rounded-[10px] border-sloid border-2"
      />
  ...
  return (
    <Link href="/" className="group">
      <div className="flex justify-center items-center gap-[10px] self-stretch">
        ...
        <h1 className="leading-7 font-semibold">Sentennial.</h1>
      </div>
    </Link>
  );
}
