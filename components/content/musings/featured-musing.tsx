...
export default function FeaturedMusing({ musing }: Props) {
  return (
    <div className="group mt-12 bg-transparent p-8 rounded-sm hover:shadow-md hover:bg-white transition-all duration-300">
            ...
            <div className="w-full">
              ...
              <div className="flex justify-between items-center mt-6 pt-4 border-t border-gray-100">
                <span className="text-sm bg-[#9dc8db]/20 text-[#9dc8db]/80 py-1 px-3 rounded-full font-mono">
                  <span className="md:inline hidden">{musing.date}</span>
                  <span className="md:hidden inline">
                    {new Date(musing.comp_date)
