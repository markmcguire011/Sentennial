      ...
      <div className="pb-20 min-h-[40vh]">
        ...
        <div className="flex flex-col gap-6 min-h-[50vh]">
          {series.status !== "completed" && (
            <div className="flex flex-col items-center justify-center py-8 px-6 bg-white/80 backdrop-blur-sm rounded-lg border shadow-sm">
              ...
              <p
                className={`text-center opacity-75 max-w-2xl text-brand-dark mb-2 ${
                  series.articles.length > 0 ? "text-lg" : "text-xl"
                }`}
              >
                {series.status === "ongoing"
                ...
                {series.status === "ongoing" && (
                  <>
                    {series.articles.length > 0
                      ? "Additional articles in this series are currently being written."
        ...
        <div className="mt-10 flex items-center gap-6">
          ...
          <Link
            href="/articles?tab=series&page=1"
            className="inline-flex items-center gap-2 text-brand-color hover:text-brand-dark transition-colors"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
