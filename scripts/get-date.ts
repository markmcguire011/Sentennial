 ...
 *
 * Usage:
 * - Run with no arguments to get current date: ts-node scripts/get_date.ts
 * - Run with a specific date: ts-node scripts/get_date.ts 2023-05-15
 * - Run with date and time: ts-node scripts/get_date.ts "2023-05-15 14:30"
 */
